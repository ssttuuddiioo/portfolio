...
type ImageItem = string | { src: string; alt?: string; title?: string; client?: string; url?: string };
...
function ImagePlane({
	...
	imageData?: { title?: string; client?: string; url?: string };
	onHover?: (hovered: boolean, data?: { title?: string; client?: string }) => void;
	...
	const handlePointerEnter = () => {
		...
		if (onHover && imageData) {
			onHover(true, { title: imageData.title, client: imageData.client });
		}
	};
	...
	const handleClick = (e: any) => {
		e.stopPropagation();
		if (onClick && imageData?.url) {
			onClick(imageData.url);
		}
	};
...
function GalleryScene({
	...
	onImageHover?: (hovered: boolean, data?: { title?: string; client?: string }) => void;
